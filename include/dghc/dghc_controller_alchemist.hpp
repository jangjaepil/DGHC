...
private:
   ...
   geometry_msgs::Pose current_ur_pose;
   Eigen::VectorXd current_position = Eigen::VectorXd::Zero(3);
   Eigen::Matrix3d current_matrix = Eigen::MatrixXd::Identity(3,3);
   Eigen::Matrix3d eRh = Eigen::Matrix3d::Identity(3,3);    
   ros::NodeHandle nh;
   ...
   ros::Publisher ur_current_pose_pub;
