...
int main(int argc, char** argv) 
{
    ...
    while(ros::ok()){ 
        ...
        if (inputValue == 0 || inputValue == 1)
        {
            ...
            if(!input.data) {
                msg.data = "8 9 10 11 12 13 14 2 0";
                // msg.data = "8 9 10 11 12 13 14 4 2 5 6 7 0";
            }
            else {
                msg.data = "8 9 10 11 12 13 14 1 2 0";
                // msg.data = "8 9 10 11 12 13 14 4 5 6 7 1 2 0";
                //msg.data = "8 9 10 11 12 13 14 6 1 0 2";
            }
